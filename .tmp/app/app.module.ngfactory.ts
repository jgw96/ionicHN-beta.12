...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __Form_57:import30.Form;
  __GestureController_58:import31.GestureController;
  __Keyboard_59:import32.Keyboard;
  __LoadingController_60:import33.LoadingController;
  __LocationStrategy_61:any;
  __Location_62:import34.Location;
  __MenuController_63:import35.MenuController;
  __ModalController_64:import36.ModalController;
  __PickerController_65:import37.PickerController;
  __PopoverController_66:import38.PopoverController;
  __TapClick_67:import39.TapClick;
  __ToastController_68:import40.ToastController;
  __Translate_69:import41.Translate;
  __TransitionController_70:import42.TransitionController;
  __UrlSerializer_71:any;
  __DeepLinker_72:any;
  __StoriesService_73:import43.StoriesService;
  __TRANSLATIONS_FORMAT_74:any;
  ...
  get _Form_57():import30.Form {
    if ((this.__Form_57 == (null as any))) { (this.__Form_57 = new import30.Form()); }
    return this.__Form_57;
  }
  get _GestureController_58():import31.GestureController {
    if ((this.__GestureController_58 == (null as any))) { (this.__GestureController_58 = new import31.GestureController(this._App_22)); }
    return this.__GestureController_58;
  }
  get _Keyboard_59():import32.Keyboard {
    if ((this.__Keyboard_59 == (null as any))) { (this.__Keyboard_59 = new import32.Keyboard(this._Config_21,this._Form_57,this.parent.get(import63.NgZone))); }
    return this.__Keyboard_59;
  }
  get _LoadingController_60():import33.LoadingController {
    if ((this.__LoadingController_60 == (null as any))) { (this.__LoadingController_60 = new import33.LoadingController(this._App_22)); }
    return this.__LoadingController_60;
  }
  get _LocationStrategy_61():any {
    if ((this.__LocationStrategy_61 == (null as any))) { (this.__LocationStrategy_61 = import8.provideLocationStrategy(this.parent.get(import66.PlatformLocation),this.parent.get(import67.APP_BASE_HREF,(null as any)),this._Config_21)); }
    return this.__LocationStrategy_61;
  }
  get _Location_62():import34.Location {
    if ((this.__Location_62 == (null as any))) { (this.__Location_62 = new import34.Location(this._LocationStrategy_61)); }
    return this.__Location_62;
  }
  get _MenuController_63():import35.MenuController {
    if ((this.__MenuController_63 == (null as any))) { (this.__MenuController_63 = new import35.MenuController()); }
    return this.__MenuController_63;
  }
  get _ModalController_64():import36.ModalController {
    if ((this.__ModalController_64 == (null as any))) { (this.__ModalController_64 = new import36.ModalController(this._App_22)); }
    return this.__ModalController_64;
  }
  get _PickerController_65():import37.PickerController {
    if ((this.__PickerController_65 == (null as any))) { (this.__PickerController_65 = new import37.PickerController(this._App_22)); }
    return this.__PickerController_65;
  }
  get _PopoverController_66():import38.PopoverController {
    if ((this.__PopoverController_66 == (null as any))) { (this.__PopoverController_66 = new import38.PopoverController(this._App_22)); }
    return this.__PopoverController_66;
  }
  get _TapClick_67():import39.TapClick {
    if ((this.__TapClick_67 == (null as any))) { (this.__TapClick_67 = new import39.TapClick(this._Config_21,this._App_22,this.parent.get(import63.NgZone))); }
    return this.__TapClick_67;
  }
  get _ToastController_68():import40.ToastController {
    if ((this.__ToastController_68 == (null as any))) { (this.__ToastController_68 = new import40.ToastController(this._App_22)); }
    return this.__ToastController_68;
  }
  get _Translate_69():import41.Translate {
    if ((this.__Translate_69 == (null as any))) { (this.__Translate_69 = new import41.Translate()); }
    return this.__Translate_69;
  }
  get _TransitionController_70():import42.TransitionController {
    if ((this.__TransitionController_70 == (null as any))) { (this.__TransitionController_70 = new import42.TransitionController(this._Config_21)); }
    return this.__TransitionController_70;
  }
  get _UrlSerializer_71():any {
    if ((this.__UrlSerializer_71 == (null as any))) { (this.__UrlSerializer_71 = import68.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_71;
  }
  get _DeepLinker_72():any {
    if ((this.__DeepLinker_72 == (null as any))) { (this.__DeepLinker_72 = import69.setupDeepLinker(this._App_22,this._UrlSerializer_71,this._Location_62)); }
    return this.__DeepLinker_72;
  }
  get _StoriesService_73():import43.StoriesService {
    if ((this.__StoriesService_73 == (null as any))) { (this.__StoriesService_73 = new import43.StoriesService(this._Http_50)); }
    return this.__StoriesService_73;
  }
  get _TRANSLATIONS_FORMAT_74():any {
    if ((this.__TRANSLATIONS_FORMAT_74 == (null as any))) { (this.__TRANSLATIONS_FORMAT_74 = (null as any)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import63.NgZone),this.parent.get(import77.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import30.Form)) { return this._Form_57; }
    if ((token === import31.GestureController)) { return this._GestureController_58; }
    if ((token === import32.Keyboard)) { return this._Keyboard_59; }
    if ((token === import33.LoadingController)) { return this._LoadingController_60; }
    if ((token === import67.LocationStrategy)) { return this._LocationStrategy_61; }
    if ((token === import34.Location)) { return this._Location_62; }
    if ((token === import35.MenuController)) { return this._MenuController_63; }
    if ((token === import36.ModalController)) { return this._ModalController_64; }
    if ((token === import37.PickerController)) { return this._PickerController_65; }
    if ((token === import38.PopoverController)) { return this._PopoverController_66; }
    if ((token === import39.TapClick)) { return this._TapClick_67; }
    if ((token === import40.ToastController)) { return this._ToastController_68; }
    if ((token === import41.Translate)) { return this._Translate_69; }
    if ((token === import42.TransitionController)) { return this._TransitionController_70; }
    if ((token === import68.UrlSerializer)) { return this._UrlSerializer_71; }
    if ((token === import69.DeepLinker)) { return this._DeepLinker_72; }
    if ((token === import43.StoriesService)) { return this._StoriesService_73; }
    if ((token === import89.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_74; }
