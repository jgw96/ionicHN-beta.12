...
import * as import22 from 'ionic-angular/components/infinite-scroll/infinite-scroll';
import * as import23 from 'ionic-angular/components/infinite-scroll/infinite-scroll-content';
...
import * as import35 from '../../node_modules/ionic-angular/components/searchbar/searchbar.ngfactory';
...
import * as import40 from '../../node_modules/ionic-angular/components/infinite-scroll/infinite-scroll-content.ngfactory';
import * as import41 from 'ionic-angular/components/item/item-sliding';
...
class _View_ShowStoriesPage_Host0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        ...
        this._ShowStoriesPage_0_4 = new import3.ShowStoriesPage(this.parentInjector.get(import8.NavController), this.parentInjector.get(import9.StoriesService), this.parentInjector.get(import10.LoadingController), this.parentInjector.get(import11.AlertController), this.parentInjector.get(import12.ToastController));
...
function viewFactory_ShowStoriesPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ShowStoriesPage_Host === null)) {
        (renderType_ShowStoriesPage_Host = viewUtils.createRenderComponentType('', 0, import13.ViewEncapsulation.None, [], {}));
    }
    return new _View_ShowStoriesPage_Host0(viewUtils, parentInjector, declarationEl);
}
export const ShowStoriesPageNgFactory = new import14.ComponentFactory('ng-component', viewFactory_ShowStoriesPage_Host0, import3.ShowStoriesPage);
...
class _View_ShowStoriesPage0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        ...
        this._Navbar_2_4 = new import16.Navbar(this.parentInjector.get(import28.App), this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import8.NavController, null), this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_2), this.renderer);
        ...
        var compView_11 = import34.viewFactory_Toolbar0(this.viewUtils, this.injector(11), this._appEl_11);
        this._Toolbar_11_4 = new import15.Toolbar(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_11), this.renderer);
        ...
        var compView_13 = import35.viewFactory_Searchbar0(this.viewUtils, this.injector(13), this._appEl_13);
        this._Searchbar_13_4 = new import19.Searchbar(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_13), this.renderer, this.parentInjector.get(import36.NgControl, null));
        ...
        this._List_16_3 = new import20.List(this.parentInjector.get(import24.Config), new import25.ElementRef(this._el_16), this.renderer, this.parentInjector.get(import37.GestureController));
        ...
        this._TemplateRef_18_5 = new import38.TemplateRef_(this._appEl_18, viewFactory_ShowStoriesPage1);
        this._NgFor_18_6 = new import21.NgFor(this._appEl_18.vcRef, this._TemplateRef_18_5, this.parentInjector.get(import39.IterableDiffers), this.ref);
        ...
        this._InfiniteScroll_21_3 = new import22.InfiniteScroll(this._Content_9_4, this.parentInjector.get(import32.NgZone), new import25.ElementRef(this._el_21));
        ...
        var compView_23 = import40.viewFactory_InfiniteScrollContent0(this.viewUtils, this.injector(23), this._appEl_23);
        this._InfiniteScrollContent_23_4 = new import23.InfiniteScrollContent(this._InfiniteScroll_21_3, this.parentInjector.get(import24.Config));
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.Searchbar) && (13 === requestNodeIndex))) {
            return this._Searchbar_13_4;
        }
        if (((token === import15.Toolbar) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Toolbar_11_4;
        }
        if (((token === import38.TemplateRef) && (18 === requestNodeIndex))) {
            return this._TemplateRef_18_5;
        }
        if (((token === import21.NgFor) && (18 === requestNodeIndex))) {
            return this._NgFor_18_6;
        }
        if (((token === import20.List) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._List_16_3;
        }
        if (((token === import23.InfiniteScrollContent) && (23 === requestNodeIndex))) {
            return this._InfiniteScrollContent_23_4;
        }
        if (((token === import22.InfiniteScroll) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 24)))) {
            return this._InfiniteScroll_21_3;
        }
        if (((token === import18.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 25)))) {
...
export function viewFactory_ShowStoriesPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ShowStoriesPage === null)) {
        (renderType_ShowStoriesPage = viewUtils.createRenderComponentType('/Users/justinwillis/Projects/myApp/.tmp/pages/show-stories/show-stories.html', 0, import13.ViewEncapsulation.None, styles_ShowStoriesPage, {}));
    }
...
class _View_ShowStoriesPage1 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        ...
        this._ItemSliding_0_4 = new import41.ItemSliding(this.parent._List_16_3, this.renderer, new import25.ElementRef(this._el_0), this.parent.parentInjector.get(import32.NgZone));
        this._query_Item_0_0 = new import42.QueryList();
        this._query_ItemOptions_0_1 = new import42.QueryList();
        ...
        this._Item_2_4 = new import43.Item(this.parent.parentInjector.get(import49.Form), this.parent.parentInjector.get(import24.Config), new import25.ElementRef(this._el_2), this.renderer);
        this._ItemContent_2_5 = new import43.ItemContent();
        this._query_Label_2_0 = new import42.QueryList();
        this._query_Button_2_1 = new import42.QueryList();
        this._query_Icon_2_2 = new import42.QueryList();
        ...
        this._ItemOptions_17_3 = new import41.ItemOptions(new import25.ElementRef(this._el_17), this.renderer);
        ...
        this._TemplateRef_19_5 = new import38.TemplateRef_(this._appEl_19, viewFactory_ShowStoriesPage2);
        this._NgIf_19_6 = new import44.NgIf(this._appEl_19.vcRef, this._TemplateRef_19_5);
        ...
        var compView_21 = import50.viewFactory_Button0(this.viewUtils, this.injector(21), this._appEl_21);
        this._Button_21_4 = new import45.Button(null, '', this.parent.parentInjector.get(import24.Config), new import25.ElementRef(this._el_21), this.renderer);
        ...
        this._Icon_23_3 = new import46.Icon(this.parent.parentInjector.get(import24.Config), new import25.ElementRef(this._el_23), this.renderer);
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        if (((token === import43.Item) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Item_2_4;
        }
        if (((token === import43.ItemContent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._ItemContent_2_5;
        }
        if (((token === import38.TemplateRef) && (19 === requestNodeIndex))) {
            return this._TemplateRef_19_5;
        }
        if (((token === import44.NgIf) && (19 === requestNodeIndex))) {
            return this._NgIf_19_6;
        }
        if (((token === import46.Icon) && (23 === requestNodeIndex))) {
            return this._Icon_23_3;
        }
        if (((token === import45.Button) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 24)))) {
            return this._Button_21_4;
        }
        if (((token === import41.ItemOptions) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 25)))) {
            return this._ItemOptions_17_3;
        }
        if (((token === import41.ItemSliding) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 26)))) {
...
class _View_ShowStoriesPage2 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import50.viewFactory_Button0(this.viewUtils, this.injector(0), this._appEl_0);
        this._Button_0_4 = new import45.Button(null, '', this.parent.parent.parentInjector.get(import24.Config), new import25.ElementRef(this._el_0), this.renderer);
    ...
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        if (((token === import45.Button) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
