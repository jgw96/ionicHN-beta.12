...
function viewFactory_AboutPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_AboutPage_Host === (null as any))) { (renderType_AboutPage_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,[],{})); }
  return new _View_AboutPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const AboutPageNgFactory:import12.ComponentFactory<import3.AboutPage> = new import12.ComponentFactory<import3.AboutPage>('ng-component',viewFactory_AboutPage_Host0,import3.AboutPage);
...
class _View_AboutPage0 extends import1.AppView<import3.AboutPage> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_4:any = this.context.jobs;
...
export function viewFactory_AboutPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AboutPage> {
  if ((renderType_AboutPage === (null as any))) { (renderType_AboutPage = viewUtils.createRenderComponentType('/Users/justinwillis/Projects/myApp/.tmp/pages/about/about.html',0,import11.ViewEncapsulation.None,styles_AboutPage,{})); }
...
class _View_AboutPage1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_5 = this.renderer.createElement((null as any),'h3',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import32.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._Item_0_4; }
    if (((token === import32.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._ItemContent_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    ...
    const currVal_2:any = import4.interpolate(1,'Poster: ',this.context.$implicit.by,'');
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setText(this._text_6,currVal_2);
      this._expr_2 = currVal_2;
    }
    const currVal_3:any = import4.interpolate(1,'',this.context.$implicit.url,'');
    if (import4.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
  ...
  private _handle_click_0_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.parent.context.goTo(this.context.$implicit.url)) !== false);
    return (true && pd_0);
  }
}
function viewFactory_AboutPage1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
